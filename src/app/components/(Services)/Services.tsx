...
export const Services = () => {
    ...
    return (
        <div ref={servicesRef} className='flex flex-col sm:flex sm:flex-col md:grid md:grid-cols-3 md:grid-rows-3 lg:grid lg:grid-cols-3 lg:grid-rows-3 xl:grid xl:grid-cols-3 xl:grid-rows-3 gap-4 border rounded-3xl p-4'>
