...
export const CommonLayout: React.FC<CommonLayoutProps> = ({ title, children }) => {
  return (
    <div className='py-32 p-6 flex flex-col mb-2 items-center justify-center tracking-wide border'>
