...
export const Hero: React.FC = () => {
    ...
    return (
        <div className="h-[80vh] w-full flex items-center justify-center border-b inset-0 bg-[radial-gradient(#f5f5f5_2px,transparent_2px)] [background-size:16px_16px] p-6">
            <div className='flex flex-col items-center justify-center '>
                <div className='text-3xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-6xl uppercase leading-normal text-center font-medium text-secondary'>
                    <h1 className='hero-title leading-normal'>
                        not just another design agency
                    </h1>
                ...
                <div className='flex flex-col items-center justify-center mt-16'>
                    ...
                    <div className='mt-4 grid grid-cols-8  gap-6 *:hover:scale-105 max-w-screen-sm'>
